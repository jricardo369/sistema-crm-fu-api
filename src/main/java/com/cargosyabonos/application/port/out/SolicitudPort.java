...
public interface SolicitudPort {
	...
	//public List<Solicitud> obtenerSolicitudesDeUsuarioPorQueryV2(UsuarioEntity us, int estatus,int idSolicitud,String fechai,String fechaf,String ordenarPor,String orden,String campo,String valor, boolean myFiles,String cerradas,boolean primeraVez, int usuario);
