...
public class CorreoElectronicoService implements CorreoElectronicoUseCase {
	...
	public void enviarCorreoCitaCancelacion(String nombre, String fecha, String hora, String tipo, String email,
			String estado, int idSolicitud, String formatoFecha, String zonaHoraria) {
		...
		envCorrPort.enviarCorreoDeLayoutCalendarWithInvite(email,
				"Interview cancellation with Familias Unidas for file " + idSolicitud, params,
				"email-cita-cancelacion");
	...
	public void enviarCorreoCitaVoc(String nombre,String fecha,String hora,String tipo,String email,int idSolicitud) {
		...
		params.put("${hora}", hora);
		params.put("${tipo}", tipo);
		envCorrPort.enviarCorreoDeLayoutCalendarWithInvite(email, "Appointment with Familias Unidas for file VOC "+idSolicitud, params, "email-cita");
