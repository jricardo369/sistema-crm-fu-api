...
public class PdfPagos {
	...
	public void generaDocumentoGeneral(Document document, SolicitudEntity solicitud, List<MovimientoEntity> movimientos)
			throws FileNotFoundException, DocumentException {
	...
	public void crearTablaLogo(Document document, SolicitudEntity s)
		...
		try {
			...
			cell = null;
			tabla2.addCell(PdfUtilidad.cell("INVOICE", pdfUtil.obtenerFont(getColores(), "tituloPdf"), 0, "izquierda",
					"", "negro"));
	...
	public PdfPTable cabecera(Document document, SolicitudEntity s)
		...
		table.addCell(PdfUtilidad.cell("Familias Unidas Counseling Center", pdfUtil.obtenerFont(getColores(), "normal"),
				0, "izquierda", "", "negro"));
		table.addCell(PdfUtilidad.cell("info@familiasunidasla.com", pdfUtil.obtenerFont(getColores(), "normal"), 0,
				"izquierda", "", "negro"));
		table.addCell(PdfUtilidad.cell("323-430-4200", pdfUtil.obtenerFont(getColores(), "normal"), 0, "izquierda", "",
				"negro"));
	...
	public PdfPTable datosInvoice(Document document, SolicitudEntity s)
		...
		table.addCell(PdfUtilidad.cell("INVOICE #:" + s.getIdSolicitud(), pdfUtil.obtenerFont(getColores(), "normal"),
				3, "izquierda", "", "negro"));
		table.addCell(PdfUtilidad.cell("INVOICE DATE:" + UtilidadesAdapter.fechaActual(),
				pdfUtil.obtenerFont(getColores(), "normal"), 3, "izquierda", "", "negro"));
	...
	public PdfPTable datosClt(Document document, SolicitudEntity s)
		...
		table.addCell(PdfUtilidad.cell("SHIP TO:", pdfUtil.obtenerFont(getColores(), "negrita"), -2, "izquierda", "",
				"negro"));
		table.addCell(PdfUtilidad.cell(s.getNombreClienteCompleto(), pdfUtil.obtenerFont(getColores(), "normal"), 0,
				"izquierda", "", "negro"));
		table.addCell(PdfUtilidad.cell(s.getDireccion() + "," + s.getEstado(),
				pdfUtil.obtenerFont(getColores(), "normal"), 0, "izquierda", "", "negro"));
		table.addCell(PdfUtilidad.cell(s.getTelefono(), pdfUtil.obtenerFont(getColores(), "normal"), 0, "izquierda", "",
				"negro"));
		table.addCell(PdfUtilidad.cell(s.getEmail() == null ? "" : s.getEmail(),
				pdfUtil.obtenerFont(getColores(), "normal"), -1, "izquierda", "", "negro"));
	...
	public void datosDetalle(Document document, List<MovimientoEntity> movimientos)
		...
		table.addCell(PdfUtilidad.cell("FOLIO", pdfUtil.obtenerFont(getColores(), "tituloTablaBlanco"), 5, "izquierda",
				"negro", "negro"));
		table.addCell(PdfUtilidad.cell("DATE", pdfUtil.obtenerFont(getColores(), "tituloTablaBlanco"), 5, "izquierda",
				"negro", "negro"));
		table.addCell(PdfUtilidad.cell("DESCRIPTION", pdfUtil.obtenerFont(getColores(), "tituloTablaBlanco"), 5,
				"izquierda", "negro", "negro"));
		table.addCell(PdfUtilidad.cell("PAYMENT METHOD", pdfUtil.obtenerFont(getColores(), "tituloTablaBlanco"), 5,
				"izquierda", "negro", "negro"));
		table.addCell(PdfUtilidad.cell("AMOUNT", pdfUtil.obtenerFont(getColores(), "tituloTablaBlanco"), 5, "izquierda",
				"negro", "negro"));
		...
		if (movimientos != null) {
			...
			if (!movimientos.isEmpty()) {
				...
				for (MovimientoEntity m : movimientos) {
					...
					table.addCell(PdfUtilidad.cell(m.getFolio() != null ? m.getFolio() : "",
					...
					table.addCell(PdfUtilidad.cell(UtilidadesAdapter.formatearFecha(m.getFecha()),
							pdfUtil.obtenerFont(getColores(), "normal"), 5, "izquierda", "", "negro"));
					table.addCell(PdfUtilidad.cell(m.getDescripcion() != null ? m.getDescripcion() : "",
							pdfUtil.obtenerFont(getColores(), "normal"), 5, "izquierda", "", "negro"));
					table.addCell(PdfUtilidad.cell(m.getTipoPago().getNombre(),
							pdfUtil.obtenerFont(getColores(), "normal"), 5, "izquierda", "", "negro"));
					table.addCell(PdfUtilidad.cell(m.getMonto(), pdfUtil.obtenerFont(getColores(), "normal"), 5,
							"izquierda", "", "negro"));
					total = total.add(m.getMonto());

				}
				table.addCell(
						PdfUtilidad.cell("", pdfUtil.obtenerFont(getColores(), "normal"), 0, "izquierda", "", "negro"));
				table.addCell(
						PdfUtilidad.cell("", pdfUtil.obtenerFont(getColores(), "normal"), 0, "izquierda", "", "negro"));
				table.addCell(
						PdfUtilidad.cell("", pdfUtil.obtenerFont(getColores(), "normal"), 0, "izquierda", "", "negro"));
				table.addCell(
						PdfUtilidad.cell("", pdfUtil.obtenerFont(getColores(), "normal"), 0, "izquierda", "", "negro"));
				table.addCell(PdfUtilidad.cell("Total:" + total, pdfUtil.obtenerFont(getColores(), "normal"), 0,
						"izquierda", "", "negro"));
			}
		}
	...
	public void titulo(Document document, String titulo, int tamaño) throws DocumentException {
		...
		table.addCell(
				PdfUtilidad.cell(titulo, pdfUtil.obtenerFont(getColores(), "negritaTitulos"), 0, "izquierda", "",
						"negro"));
